...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>RE-VEND</title>
      <link rel="icon" type="image/x-icon"  href="images/tondoo.png">
   ...
   <body>
      ...
      <div class="banner_bg_main">
         ...
         <div class="logo_section">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                     <div class="logo"><a href="index.php" ><img class="sium" src="images/logooo.png"></a></div>
                  </div>
               </div>
            </div>
         </div>
                     ...
                     <div class="login_menu"> 
                        <ul><!--
                           ...
                           <li><a href="profile.php">
                              ...
                              <span class="padding_10">PROFILO</span></a>
                           </li>
                        </ul>
                     </div>
                  </div>
               ...
               <div id="my_slider" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                     <div class="carousel-item active">
                        <div class="row">
                           <div class="col-sm-12">
                              <h1 class="banner_taital">Get Start <br>lo shop perfetto per te</h1>
                              <div class="buynow_bt"><a href="login.php">start Now</a></div>
                           </div>
                        </div>
                     </div>
                     <div class="carousel-item">
                        <div class="row">
                           <div class="col-sm-12">
                              <h1 class="banner_taital">Get Start <br>trova prodotti e venditori</h1>
                              <div class="buynow_bt"><a href="#">start Now</a></div>
                           </div>
                        </div>
                     </div>
                     <div class="carousel-item">
                        <div class="row">
                           <div class="col-sm-12">
                              <h1 class="banner_taital">Get Start <br>carica un articolo</h1>
                              <div class="buynow_bt"><a href="#">start Now</a></div>
                           </div>
                        </div>
                     </div>
      ...
      <div class="fashion_section">
         <div id="main_slider" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                     <br><br>
                     <h1 class="fashion_taital" id="content">
                     <?php 
                     if( !empty($_SESSION['loggato'])){
                                       ...
                                       while($COLONNA = $result->fetch_assoc()) {
                                          ...
                                          if( empty($_SESSION["pw"]) && empty($_SESSION["email"]) ){
                                             ...
                                             <div class="col-lg-4 col-sm-4">
                                                <div class="box_main">
                                                   <h4 class="shirt_text"> <?php echo $COLONNA['NomeOggetto'] ?> </h4>
                                                   <p class="price_text">Caricata da  <span style="color: #262626;"> <?php echo $COLONNA['Nome'] ?></span></p>
                                                   <div class="tshirt_img"><img class="imma" src="<?php echo $COLONNA['Foto'] ?>"></div>
                                                   <p class="price_text"><?php echo $COLONNA['Descrizione'] ?></p>
                                                   <form  action='offercode.php' method='POST'>
                                                ...
                                                if($_SESSION['pw'] != $COLONNA['Password'] && $_SESSION['email'] != $COLONNA['Email']){
                                                   ...
                                                   <div class="col-lg-4 col-sm-4">
                                                      <div class="box_main">
                                                         ...
                                                         <p class="price_text">Caricata da  <span style="color: #262626;"> <?php echo $COLONNA['Nome'] ?></span></p>
                                                         <div class="tshirt_img"><img class="imma" src="<?php echo $COLONNA['Foto'] ?>"></div>
                                                         <p class="price_text"><?php echo $COLONNA['Descrizione'] ?></p><br><br>
      ...
      <div class="footer_section layout_padding">
         <div class="container">
            <div class="footer_logo"><a href="index.html"><img class="sium" src="images/logooo.png"></a></div> <br><br>
            <div class="input_bt">
