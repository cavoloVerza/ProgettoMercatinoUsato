        ...
        <div class="container text-center mt-5">
            ...
            <div class="row">
                <div class="col-12 my-4">
                    ...
                    <form action="../../php/LoginPHP/LoginCode.php" method="POST" class="mb-5">
                    ...
                    <a href="RegistrazionePage.php"><button type="button" class="btn btn-secondary">Registrati</button></a>
            ...
            <div class="row">
                <div class="col-12 my-4">
                    ...
                    <?php
                        ...
                        if(isset($_SESSION["flagLoginErrore"])) {

                            echo "<h1>Errore</h1>";
                            echo "<p>" . $_SESSION["errorReg"] . "</p>";
                        }

                        if(isset($_SESSION["flagLoginSuccesso"])) {
