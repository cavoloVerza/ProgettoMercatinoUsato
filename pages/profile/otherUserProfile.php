...
<body>
  ...
  <div class="container">
    <div class="row row-cols-1 row-cols-md-3 g-4" id="rowina">
      ...
      $sql2 = "SELECT  Nome, Cognome, Eta, Email  FROM utente WHERE utente.Email = '$email'";
      ...
      $sql = "SELECT * FROM oggetto JOIN utente ON oggetto.IdUtente = utente.ID WHERE utente.Email = '$email'";   
